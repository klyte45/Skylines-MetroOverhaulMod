...
namespace NetworkSkins.Data
{
    public class SegmentDataManager : SerializableDataExtensionBase
    {
        ...
        {
            Next.Debug.Log("OnSegmentCreate");
            if (SegmentToSegmentDataMap == null)
            {
                Next.Debug.Log("NO STSDM");
                return;
            }
        ...
        {
            Next.Debug.Log("OnSegmentRelease");
        ...
        {
            Next.Debug.Log("OnSegmentTransferData");
            if (SegmentToSegmentDataMap == null)
            {
                Next.Debug.Log("STSDM in transfer null");
                return;
            }
